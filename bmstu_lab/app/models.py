...
class RequestsServices(models.Model):
    bank_service = models.OneToOneField(BankServices, models.DO_NOTHING, primary_key=True)  # The composite primary key (bank_service_id, request_id) found, that is not supported. The first column is selected.
